...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Sometimes fonts load later or elements wrap slightly differently after first paint
  ...
  return (
    <>
      <div id="main-header" className="fixed top-0 inset-x-0 z-50 flex flex-col">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 justify-center sm:justify-end order-2 pt-1 sm:pt-0">
              <a
                ...
                className="flex items-center gap-2 hover:text-clinic-gold transition-colors"
              >
          ...
          <div className="max-w-7xl mx-auto w-full px-6 md:px-12 flex items-center justify-between">
            ...
            <div className="hidden lg:flex justify-center gap-8 text-[11px] uppercase tracking-[0.15em] font-semibold text-clinic-teal-900/70 items-center">
              ...
              >
                ...
                <AnimatePresence>
                  {servicesDropdownOpen && (
                    ...
                    >
                      <Link
                        to="/services#consultation-diagnostic-services"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Consultation & Diagnostic
                      </Link>
                      <Link
                        to="/services#panchakarma-detox-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Panchakarma & Detox
                      </Link>
                      <Link
                        to="/services#pain-management-musculoskeletal-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Pain & Musculoskeletal
                      </Link>
                      <Link
                        to="/services#rejuvenation-wellness-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Rejuvenation & Wellness
                      </Link>
                      <Link
                        to="/services#women-s-wellness-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Women's Wellness
                      </Link>
                      <Link
                        to="/services#child-wellness-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Child Wellness
                      </Link>
                      <Link
                        to="/services#skin-hair-beauty-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Skin, Hair & Beauty
                      </Link>
                      <Link
                        to="/services#immunity-rejuvenation-therapies"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors border-b border-clinic-border/30"
                      >
                        Immunity & Rejuvenation
                      </Link>
                      <Link
                        to="/services#wellness-lifestyle-programs"
                        className="px-4 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors"
                      >
                        Wellness & Lifestyle
                      </Link>
                    </motion.div>
              ...
              >
                ...
                <AnimatePresence>
                  {treatmentsDropdownOpen && (
                    ...
                    >
                      <Link
                        to="/treatments/journey"
                        className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors w-full border-b border-clinic-border/30 font-bold tracking-widest bg-clinic-teal-50/50 text-clinic-teal-900 flex items-center justify-between"
                      >
                        Treatment Journey
                        <span className="bg-amber-100 text-amber-800 border border-amber-200 px-1.5 py-0.5 rounded text-[8px] font-bold tracking-wider relative -top-0.5 animate-pulse flex items-center gap-1 shadow-sm">
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full animate-ping absolute opacity-75"></span>
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full relative"></span>
                          EXPLORE
                        </span>
                      </Link>
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#musculoskeletal-joint-care"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full"
                        >
                          Musculoskeletal & Joint Care
                          <ChevronRight className="w-3 h-3" />
                        </Link>
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/cervical-lumbar-spondylitis"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                            Cervical & Lumbar Spondylitis (Manyastambha &
                            Katigraha)
                          </Link>
                          <div className="px-4 py-2 text-clinic-teal-900 font-bold border-b border-clinic-border/30 bg-clinic-teal-50/50">
                            Chronic Pain
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#digestive-metabolic-health"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/irritable-bowel-syndrome"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/diabetes-management"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/thyroid-dysfunction"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/cholesterol-management"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/heart-health-support"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#skin-hair-aesthetic-wellness"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/acne-pigmentation"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/chronic-allergies"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#women-s-health-fertility"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/menstrual-irregularities"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/fertility-support"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/repeated-miscarriages-support"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/lactation-support"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#mental-health-neurology"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/anxiety-insomnia"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/parkinson-s-disease"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/stroke-paralysis-rehabilitation"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/memory-concentration"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#respiratory-immune-health"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/chronic-sinusitis"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#men-s-health-urology"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/erectile-dysfunction"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/premature-ejaculation"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/urinary-incontinence"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/neurogenic-bladder"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                      ...
                      <div className="group/sub w-full">
                        <Link
                          to="/treatments#pediatric-child-healthcare"
                          className="px-5 py-3 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex justify-between items-center w-full border-t border-clinic-border/30"
                        >
                        ...
                        <div className="absolute top-0 left-[98%] w-72 bg-white border border-clinic-border shadow-xl rounded-sm py-2 hidden group-hover/sub:flex flex-col z-[110] max-h-[85vh] overflow-y-auto">
                          ...
                          <Link
                            to="/conditions/seasonal-allergies"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                            Seasonal Allergies
                          ...
                          <Link
                            to="/conditions/digestive-weakness"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
                          ...
                          <Link
                            to="/conditions/concentration-support"
                            className="px-5 py-2 hover:bg-clinic-teal-50 hover:text-clinic-bronze transition-colors flex items-center gap-2 capitalize text-xs font-medium border-b border-clinic-border/10 leading-snug"
                          >
                            <span className="w-1 h-1 rounded-full bg-clinic-bronze flex-shrink-0"></span>
              ...
              >
                <Link
                  to="/dosha-quiz"
                  className={`cursor-pointer flex items-center gap-1 border-b transition-all pb-0.5 ${
                    isActive("/dosha-quiz") ||
                    isActive("/lifestyle-tips") ||
                    isActive("/store")
                      ? "text-clinic-teal-900 border-clinic-gold"
                      : "hover:text-clinic-teal-900 border-transparent hover:border-clinic-gold"
                  }`}
                ...
                <AnimatePresence>
                  {shopDropdownOpen && (
                    ...
                    >
                      <Link
                        to="/announcements"
                        className="px-4 py-2 hover:bg-clinic-teal-50 hover:text-clinic-teal-900 transition-colors flex items-center justify-between"
                      >
                        Announcements
                        <span className="bg-amber-100 text-amber-800 border border-amber-200 px-1.5 py-0.5 rounded text-[8px] font-bold tracking-wider relative -top-0.5 animate-pulse flex items-center gap-1 shadow-sm">
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full animate-ping absolute opacity-75"></span>
              ...
              >
                <Link
                  ...
                  className={`flex items-center gap-1 border-b transition-all pb-0.5 ${
                    ...
                    isActive("/about-sattvic-ayurveda/contactus")
                      ? "text-clinic-teal-900 border-clinic-gold"
                      : "hover:text-clinic-teal-900 border-transparent hover:border-clinic-gold"
                  }`}
                >
          ...
          >
            ...
            <div className="flex flex-col gap-6 text-[13px] uppercase tracking-[0.15em] font-semibold text-clinic-teal-900/70">
              <Link
                ...
                className={`border-b border-clinic-border pb-4 ${isActive("/") ? "text-clinic-teal-900" : "hover:text-clinic-teal-900"}`}
              >
                Home
              </Link>
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      setMobileExpanded(
                        mobileExpanded === "treatments" ? null : "treatments",
                      )
                    }
                    className={`p-2 rounded-full transition-all duration-300 focus:outline-none flex items-center justify-center ${
                  ...
                  >
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${mobileExpanded === "treatments" ? "rotate-180" : ""}`}
                    />
                  </button>
                </div>
                <AnimatePresence>
                  {mobileExpanded === "treatments" && (
                    ...
                    >
                      <Link
                        ...
                        className="py-4 pr-4 uppercase text-[11px] font-bold tracking-widest text-clinic-teal-900 border-b border-clinic-border/50 bg-clinic-teal-50/50 flex items-center justify-between"
                      >
                        Treatment Journey
                        <span className="bg-amber-100 text-amber-800 border border-amber-200 px-2 py-0.5 rounded text-[10px] font-bold tracking-wider flex items-center gap-1 shadow-sm animate-pulse">
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full animate-ping absolute opacity-75"></span>
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full relative"></span>
                          EXPLORE
                        </span>
                      ...
                      <div className="flex flex-col border-b border-clinic-border/50">
                        <Link
                          ...
                          className="py-4 uppercase text-clinic-teal-900/80 font-medium hover:text-clinic-teal-900"
                        >
                          Musculoskeletal & Joint Care
                        </Link>
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      setMobileExpanded(
                        mobileExpanded === "wellness" ? null : "wellness",
                      )
                    }
                    className={`p-2 rounded-full transition-all duration-300 focus:outline-none flex items-center justify-center ${
                  ...
                  >
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${mobileExpanded === "wellness" ? "rotate-180" : ""}`}
                    />
                  </button>
                </div>
                <AnimatePresence>
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  >
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${mobileExpanded === "shop" ? "rotate-180" : ""}`}
                    />
                  </button>
                </div>
                <AnimatePresence>
                  {mobileExpanded === "shop" && (
                    ...
                    >
                      <Link
                        ...
                        className="py-4 border-b border-clinic-border/50 uppercase flex items-center justify-between"
                      >
                        Announcements
                        <span className="bg-amber-100 text-amber-800 border border-amber-200 px-2 py-0.5 rounded text-[10px] font-bold tracking-wider flex items-center gap-1 shadow-sm animate-pulse">
                          <span className="w-1.5 h-1.5 bg-amber-500 rounded-full animate-ping absolute opacity-75"></span>
              ...
              <div className="flex flex-col">
                <div
                  className={`border-b border-clinic-border pb-3 w-full flex justify-between items-center ${isActive("/about-sattvic-ayurveda") || isActive("/about-sattvic-ayurveda/centre") || isActive("/about-sattvic-ayurveda/doctors/dr-khan-aqsa-zarin") || isActive("/about-sattvic-ayurveda/contactus") ? "text-clinic-teal-900" : "hover:text-clinic-teal-900"}`}
                >
                  <Link
                    to="/about-sattvic-ayurveda"
                    onClick={() => setMobileMenuOpen(false)}
            ...
            <div className="mt-auto pb-8 pt-8 flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 text-[13px] uppercase tracking-[0.15em] font-bold text-green-700 border border-green-700/30 bg-green-50 px-6 py-4 rounded-sm shadow-sm transition-colors hover:bg-green-100"
              >
              ...
              <a
                href="tel:+919404417145"
                className="flex items-center justify-center gap-2 text-[13px] uppercase tracking-[0.15em] font-bold text-clinic-teal-900 border border-clinic-border bg-white px-6 py-4 rounded-sm shadow-sm"
              >
